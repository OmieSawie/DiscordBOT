...
client.on('interactionCreate', async interaction => {
	...
	if (commandName === 'ping') {
        ...
        //console.log(formattedTime);   
            await interaction.editReply(`The contest list is as follows:\n\n\n ${JSON.stringify(listReply.result[0], null, 2)} \n\n\n\n   \n ${JSON.stringify(listReply.result[1], null, 2)} \n\n\n\n  \n${JSON.stringify(listReply.result[2], null, 2)} \n\n\n\n  \n${JSON.stringify(listReply.result[3], null, 2)} \n\n\n\n  \n${JSON.stringify(listReply.result[4], null, 2)} \n
                `) ;
        }
});
